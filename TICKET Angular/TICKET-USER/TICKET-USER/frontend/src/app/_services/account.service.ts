...
export class AccountService {
    ...
    constructor(
        ...
        this.ticketSubject = new BehaviorSubject<Ticket>(JSON.parse(localStorage.getItem('Ticket')));
    ...
    create_ticket(ticket: Ticket) {
        return this.http.post(`${environment.apiUrl}/tickets/create_ticket`, ticket);
    }
    ...
    update1(id, params) {
        return this.http.put(`${environment.apiUrl}/tickets/${id}`, params)
            .pipe(map(x => {
                ...
                //     // publish updated ticket to subscribers
