...
//   }
  ...
  >
    ...
    <TableContainer component={Paper}>
      <Table sx={{ minWidth: 650, backgroundColor:"#2D98AB"  }} className={classes.table} aria-label="simple table">
        <TableHead>
          <TableRow>
        ...
        <TableBody>
          {currentItems?.map((ticket, index) => (
            <TableRow key={ticket._id} style={{backgroundColor: ticket.isDelete ? '#81C6D2' : '#fff'}}>
